...
//       ) : paginated.length === 0 ? (
//         <div className="text-center text-gray-400 py-20">No menu found</div>
//       ) : (
...
export default function MenuTable({ shopId }) {
  ...
  return (
    <div className="mb-6">
      {/* TITLE */}
      <div className="flex justify-between items-center mb-5">
        <h2 className="text-2xl font-semibold text-indigo-400">Menu List</h2>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-7 gap-4">
          {paginated.map((item) => (
            <div
              key={item.id}
              className={`relative rounded-2xl overflow-hidden border transition-all duration-300 bg-[#111827] shadow-lg
