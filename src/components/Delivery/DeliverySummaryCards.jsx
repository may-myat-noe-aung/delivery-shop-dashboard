...
if (!res) return;
  ...
  return (
    <section className="grid grid-cols-4 gap-3 lg:gap-4 xl:gap-5 mb-5">
      ...
      {/* ONLINE */}
      <DashboardCard
        title="Online Delivery Men"
        value={data.total_online_deliverymen}
        icon={
          <Wifi className="text-emerald-300 w-3 h-3 lg:w-4 lg:h-4 xl:w-5 xl:h-5" />
        }
      ...
      {/* OFFLINE */}
      <DashboardCard
        title="Offline Delivery Men"
        value={data.total_offline_deliverymen}
        icon={
          <WifiOff className="text-rose-300 w-3 h-3 lg:w-4 lg:h-4 xl:w-5 xl:h-5" />
        }
      ...
      {/* TODAY */}
      <DashboardCard
        title="Today's Delivery Men"
        value={data.today_deliverymen}
        icon={
          <CalendarCheck className="text-sky-300 w-3 h-3 lg:w-4 lg:h-4 xl:w-5 xl:h-5" />
        }
