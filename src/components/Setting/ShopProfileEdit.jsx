...
//   const categories = [
//     { id: 1, name: "Snack", icon: "snack" },
//     { id: 2, name: "Alcoholic", icon: "alcoholic" },
//     { id: 3, name: "Breakfast", icon: "breakfast" },
//     { id: 4, name: "Cake", icon: "cake" },
//     { id: 5, name: "Coffee", icon: "coffee" },
//     { id: 6, name: "Drink", icon: "drink" },
//     { id: 7, name: "Fast Food", icon: "fastfood" },
//     { id: 8, name: "Lunch", icon: "lunch" },
//     { id: 9, name: "Morning", icon: "morning" },
//     { id: 10, name: "Sweets", icon: "sweets" },
//   ];
...
//                           <p className="text-sm mt-2 text-white">{item.name}</p>
//                         </button>
//                       );
//                     })}
//                   </div>
