...
//   return (
//     <div className="text-white min-h-[900px]">
//       {/* TOP MENU */}
...
//         <div
//           className={`
//     ${tab === "profile" ? "block" : "hidden xl:hidden 2xl:block"}
//     xl:col-span-1
//   `}
//         >
//           {shop && (
...
//                       }
//                       label={shop.open_shop === 1 ? "Shop Open" : "Shop Closed"}
//                     />
...
//         <div
//           className={
//             tab === "profile" ? "xl:col-span-2" : "xl:col-span-3 2xl:col-span-2"
//           }
//         >
//           <div className="">
...
export default function ShopSettings() {
  ...
  return (
    <div className="text-white min-h-[1060px]">
      {/* TOP MENU */}
      <div className="border border-slate-800 rounded-3xl p-4 h-fit mb-6">
        <div className="flex flex-row items-center gap-4">
          {tabs.map((item) => (
          ...
          {shop && (
            <div className="sticky top-6">
              <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-br from-indigo-600/20 via-slate-900 to-slate-950 p-4 md:p-6">
                ...
                <div className="relative flex flex-col items-center text-center ">
                  <div className="absolute -top-4 2xl:-top-4 -right-2 2xl:right-0 z-50">
                    {shop.status === "active" ? (
                      <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-500/20 backdrop-blur-md border border-green-400/30">
                        <Check size={14} className="text-green-400" />
                        <span className="text-xs font-medium text-green-300">
                  ...
                  {/* FACEBOOK STYLE PROFILE IMAGE */}
                  <div className="relative w-full">
                    {/* COVER PHOTO */}
                    <div className="w-full h-48 rounded-3xl overflow-hidden border border-white/10">
                      <img
                        src={
                          shop.photo
    ...
    "
                      >
                        <img
                          src={
                            shop.logo
                              ? `https://api.pwezayshops.com/shop-uploads/${shop.logo}`
                              : shop.photo
                                ? `https://api.pwezayshops.com/shop-uploads/${shop.photo}`
                                : "/default-logo.png"
                          }
